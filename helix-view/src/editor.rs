...
pub struct Config {
    ...
    /// Whether to highlight matching brackets if the bracket is on the position before the cursor.
    /// Defaults to `false`.
    pub highlight_brackets_before_cursor: bool,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            highlight_brackets_before_cursor: false,
